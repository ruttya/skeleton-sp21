...
public class TestOthers {
    ...
    public void testPluckTheAString() {
        ...
        aString.pluck();
        for (int i = 0; i < 50000; i += 1) { //这个50000相当于SR
    ...
    @Test
    public void testHarpAString() {
        Harp aString = new Harp(GuitarHeroLite.CONCERT_A);
        Harp cString = new Harp(GuitarHeroLite.CONCERT_C);
        Harp xString = new Harp(GuitarHeroLite.CONCERT_A * Math.pow(2, (4 - 24) / 12.0));
        aString.pluck();
        cString.pluck();
        xString.pluck();
        for (int i = 0; i < 80000; i += 1) { //这个50000相当于SR
            StdAudio.play(aString.sample());
            aString.tic();
        }
        for (int i = 0; i < 80000; i += 1) { //这个50000相当于SR
    ...
    @Test
    public void testDrumString() {
        Drum aString = new Drum(GuitarHeroLite.CONCERT_A);
        Drum cString = new Drum(GuitarHeroLite.CONCERT_C);
        Drum xString = new Drum(GuitarHeroLite.CONCERT_A * Math.pow(2, (4 - 24) / 12.0));
        aString.pluck();
        cString.pluck();
        xString.pluck();
        for (int i = 0; i < 50000; i += 1) { //这个50000相当于SR
